...
def get_light_curve(opt, planet_sed, wavelength, obs_type):
    ...
    gamma[:,0] = ldc[1]
    gamma[:,1] = ldc[2]    
    exosim_n_plot('ldc', opt.diagnostics, ydata =ldc[1])
    exosim_n_plot('ldc', opt.diagnostics, ydata =ldc[2])      
    ...
    if obs_type == 1: #primary transit
        for i in range(len(planet_sed)):   
              ...
              exosim_n_plot('light curve check', opt.diagnostics, ydata = lc[i, ...] )              
...
def getLDC_interp(opt, planet, wl):
        ...
        exosim_n_msg ('Calculating LDC from pre-installed files', 1)
        T = planet.star.T.value
        if T < 3000.0:  # temp fix as LDCs not available for T< 3000 K
            T=3000.0
        logg = planet.star.logg
        exosim_n_msg ("T_s, logg>>>> %s %s"%(T, logg ), opt.diagnostics)
        folder = '%s/archive/LDC'%(opt.exosim_n_path)        
        ...
        exosim_n_plot('ldc interp logg1', opt.diagnostics, ydata=u0_a, marker='b-')
        exosim_n_plot('ldc interp logg1', opt.diagnostics, ydata=u0_b, marker='r-')   
        exosim_n_plot('ldc interp logg1', opt.diagnostics, ydata=u0_1, marker='g-')
        exosim_n_plot('ldc interp logg1', opt.diagnostics, ydata=u1_a, marker='b-')
        exosim_n_plot('ldc interp logg1', opt.diagnostics, ydata=u1_b, marker='r-')
        exosim_n_plot('ldc interp logg1', opt.diagnostics, ydata=u1_1, marker='g-')
        ...
        exosim_n_plot('ldc interp logg2', opt.diagnostics, ydata=u0_a, marker='b-')
        exosim_n_plot('ldc interp logg2', opt.diagnostics, ydata=u0_b, marker='r-')   
        exosim_n_plot('ldc interp logg2', opt.diagnostics, ydata=u0_2, marker='g-')
        exosim_n_plot('ldc interp logg2', opt.diagnostics, ydata=u1_a, marker='b-')
        exosim_n_plot('ldc interp logg2', opt.diagnostics, ydata=u1_b, marker='r-')
        exosim_n_plot('ldc interp logg2', opt.diagnostics, ydata=u1_2, marker='g-')        
        #==============================================================================
        ...
        exosim_n_plot('ldc interp', opt.diagnostics, ydata=u0_1, marker='b-')
        exosim_n_plot('ldc interp', opt.diagnostics, ydata=u0_2, marker='r-')   
        exosim_n_plot('ldc interp', opt.diagnostics, ydata=u0, marker='g-')
        exosim_n_plot('ldc interp', opt.diagnostics, ydata=u1_1, marker='b-')
        exosim_n_plot('ldc interp', opt.diagnostics, ydata=u1_2, marker='r-')
        exosim_n_plot('ldc interp', opt.diagnostics, ydata=u1, marker='g-')        
        #==============================================================================
        ...
        exosim_n_plot('ldc final', opt.diagnostics, xdata = ldc_wl,  ydata=u0, marker='ro', alpha=0.1)
        exosim_n_plot('ldc final', opt.diagnostics, xdata = ldc_wl,  ydata=u1, marker='bo', alpha=0.1)
        exosim_n_plot('ldc final', opt.diagnostics, xdata = wl,  ydata=u0_final, marker='rx')
        exosim_n_plot('ldc final', opt.diagnostics, xdata = wl,  ydata=u1_final, marker='bx')
